...
This will forma a basis because any vector can be written as a sum of basis vectors.
...
So long as you don't have something truly insane, you can zoom in on some teeny tiny point (starting to sound familiar?)
