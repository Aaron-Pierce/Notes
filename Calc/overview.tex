...
Usually you can just eyeball it by remembering that r is $x^2 + y^2$.

Integrals are now a little weird. 
It's kinda hard to get squares out of polar coordinates.
...
Quick recap of all of that, some teeny $d\theta$ will form a triangle because the arc of the circle that is created by $d\theta$ is a line as we get infinitely small.
...
\end{figure}
The super important thing is to remember how to find the area of that triangle.
...
\end{gather*}
If $r$ is constant (your domain is a (portion of a) circle), you're in luck, but frequently $r$ is some function of theta, so it may be better to remember it as

\begin{gather*}
    \iint f(r, \theta) \cdot r(\theta)  \,drd\theta
\end{gather*}
\end{document}